...
public class ForgottenWoodFenceBlock extends TherazorhailModModElements.ModElement {
	@ObjectHolder("therazorhail_mod:forgotten_wood_fence")
	public static final Block block = null;
	public ForgottenWoodFenceBlock(TherazorhailModModElements instance) {
		super(instance, 51);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("forgotten_wood_fence");
		}
