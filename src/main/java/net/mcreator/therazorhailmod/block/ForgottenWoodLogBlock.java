...
public class ForgottenWoodLogBlock extends TherazorhailModModElements.ModElement {
	@ObjectHolder("therazorhail_mod:forgotten_wood_log")
	public static final Block block = null;
	public ForgottenWoodLogBlock(TherazorhailModModElements instance) {
		super(instance, 46);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("forgotten_wood_log");
		}
