...
public class ForgottenDirtBlock extends TherazorhailModModElements.ModElement {
	@ObjectHolder("therazorhail_mod:forgotten_dirt")
	public static final Block block = null;
	public ForgottenDirtBlock(TherazorhailModModElements instance) {
		super(instance, 72);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("forgotten_dirt");
		}
