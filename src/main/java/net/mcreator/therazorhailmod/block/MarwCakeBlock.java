...
public class MarwCakeBlock extends TherazorhailModModElements.ModElement {
	@ObjectHolder("therazorhail_mod:marw_cake")
	public static final Block block = null;
	public MarwCakeBlock(TherazorhailModModElements instance) {
		super(instance, 41);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.CAKE).sound(SoundType.SLIME).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0).notSolid()
					.setOpaque((bs, br, bp) -> false));
			setRegistryName("marw_cake");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MarwCakeBlock.block));
		}
