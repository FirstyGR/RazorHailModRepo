...
public class ForgottenWoodPressurePlateBlock extends TherazorhailModModElements.ModElement {
	@ObjectHolder("therazorhail_mod:forgotten_wood_pressure_plate")
	public static final Block block = null;
	public ForgottenWoodPressurePlateBlock(TherazorhailModModElements instance) {
		super(instance, 53);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("forgotten_wood_pressure_plate");
		}
