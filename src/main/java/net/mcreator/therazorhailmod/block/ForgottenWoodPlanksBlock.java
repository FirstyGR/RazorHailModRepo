...
public class ForgottenWoodPlanksBlock extends TherazorhailModModElements.ModElement {
	@ObjectHolder("therazorhail_mod:forgotten_wood_planks")
	public static final Block block = null;
	public ForgottenWoodPlanksBlock(TherazorhailModModElements instance) {
		super(instance, 47);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("forgotten_wood_planks");
		}
