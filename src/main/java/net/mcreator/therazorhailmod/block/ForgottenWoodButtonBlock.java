...
public class ForgottenWoodButtonBlock extends TherazorhailModModElements.ModElement {
	@ObjectHolder("therazorhail_mod:forgotten_wood_button")
	public static final Block block = null;
	public ForgottenWoodButtonBlock(TherazorhailModModElements instance) {
		super(instance, 54);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("forgotten_wood_button");
		}
