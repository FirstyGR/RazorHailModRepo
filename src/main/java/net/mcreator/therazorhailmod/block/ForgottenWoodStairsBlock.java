...
public class ForgottenWoodStairsBlock extends TherazorhailModModElements.ModElement {
	@ObjectHolder("therazorhail_mod:forgotten_wood_stairs")
	public static final Block block = null;
	public ForgottenWoodStairsBlock(TherazorhailModModElements instance) {
		super(instance, 49);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("forgotten_wood_stairs");
		}
