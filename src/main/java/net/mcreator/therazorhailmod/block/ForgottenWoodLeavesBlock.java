...
public class ForgottenWoodLeavesBlock extends TherazorhailModModElements.ModElement {
	@ObjectHolder("therazorhail_mod:forgotten_wood_leaves")
	public static final Block block = null;
	public ForgottenWoodLeavesBlock(TherazorhailModModElements instance) {
		super(instance, 48);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("forgotten_wood_leaves");
		}
