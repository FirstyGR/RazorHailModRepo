...
public class ForgottenWoodWoodBlock extends TherazorhailModModElements.ModElement {
	@ObjectHolder("therazorhail_mod:forgotten_wood_wood")
	public static final Block block = null;
	public ForgottenWoodWoodBlock(TherazorhailModModElements instance) {
		super(instance, 45);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("forgotten_wood_wood");
		}
