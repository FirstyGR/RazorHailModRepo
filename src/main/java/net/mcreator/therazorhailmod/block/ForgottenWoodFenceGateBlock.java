...
public class ForgottenWoodFenceGateBlock extends TherazorhailModModElements.ModElement {
	@ObjectHolder("therazorhail_mod:forgotten_wood_fence_gate")
	public static final Block block = null;
	public ForgottenWoodFenceGateBlock(TherazorhailModModElements instance) {
		super(instance, 52);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("forgotten_wood_fence_gate");
		}
