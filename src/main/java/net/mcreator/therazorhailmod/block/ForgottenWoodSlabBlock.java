...
public class ForgottenWoodSlabBlock extends TherazorhailModModElements.ModElement {
	@ObjectHolder("therazorhail_mod:forgotten_wood_slab")
	public static final Block block = null;
	public ForgottenWoodSlabBlock(TherazorhailModModElements instance) {
		super(instance, 50);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("forgotten_wood_slab");
		}
