...
public class ForgottenSandstoneBlock extends TherazorhailModModElements.ModElement {
	@ObjectHolder("therazorhail_mod:forgotten_sandstone")
	public static final Block block = null;
	public ForgottenSandstoneBlock(TherazorhailModModElements instance) {
		super(instance, 80);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("forgotten_sandstone");
		}
