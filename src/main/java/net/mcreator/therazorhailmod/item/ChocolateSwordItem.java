...
public class ChocolateSwordItem extends TherazorhailModModElements.ModElement {
	@ObjectHolder("therazorhail_mod:chocolate_sword")
	public static final Item block = null;
	public ChocolateSwordItem(TherazorhailModModElements instance) {
		super(instance, 68);
	}
