...
package net.mcreator.therazorhailmod.particle;
...
public class DementiaParticlesParticle {
	public static final BasicParticleType particle = new BasicParticleType(false);
	@SubscribeEvent
	public static void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("dementia_particles"));
	}
